...
/**
 * A Silver Member is a Bonus Member with the next highest amount of privileges
 * where their base points are multiplied by {@link BonusMember#FACTOR_SILVER}.
 * 
...
public class SilverMember extends BonusMember {
	 ...
	 * @param bonusPoints  is the amount of bonus points that this member has
	 *                     previously.
	 */
