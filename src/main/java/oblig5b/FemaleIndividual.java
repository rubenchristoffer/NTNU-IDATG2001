...
/**
 * Represents a female individual. A female can give birth, represented by the
 * field noLitters.
 */
class FemaleIndividual extends Individual {
	 ...
	 */
	public FemaleIndividual(String norName, String latName, String latFamily, LocalDate arrivalDate, String name,
			LocalDate dateOfBirth, boolean isDangerous, String address, int noLitters) {
	 ...
	 *
	 * @param number the number of children to increase the total number of children
	 *               by.
	 */
