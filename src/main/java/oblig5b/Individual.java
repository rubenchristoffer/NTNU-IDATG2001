...
abstract class Individual extends Animal {
	 ...
	 */
	public Individual(String norName, String latName, String latFamily, LocalDate arrivalDate, String name,
			LocalDate dateOfBirth, boolean isDangerous, String address) {
	...
	/**
	 * Returns <code>true</code> if the animal can be dangerous for the visitors of
	 * the Zoo. <code>false</code> if not.
	 *
	 * @return <code>true</code> if the animal can be dangerous for the visitors of
	 *         the Zoo. <code>false</code> if not.
	 */
	...
	/**
	 * Sets whether or not the individual might be dangerous for the visitors of the
	 * Zoo.
	 *
