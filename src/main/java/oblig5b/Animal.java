...
/**
 * Represents an animal described by a norwegian name, a latin name, and the
 * family in latin.
 */
abstract class Animal {
	 ...
	 * @param address     the address of the animal in the Zoo (which location in
	 *                    the Zoo)
	 */
	public Animal(String norName, String latName, String latFamily, LocalDate arrivalDate, String address) {
