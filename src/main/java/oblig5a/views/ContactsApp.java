...
import oblig5a.controllers.MainController;
import oblig5a.model.AddressBook;
import oblig5a.model.AddressBookDBHandler;
import oblig5a.model.ContactDetails;
...
public class ContactsApp extends Application {
	...
	private ToolBar createToolBar() {
		...
		addContactBtn.setGraphic(
				new ImageView(new Image(getClass().getResource("./icons/add_contact@2x.png").toExternalForm())));
		...
		editContactBtn.setGraphic(
				new ImageView(new Image(getClass().getResource("./icons/edit_contact@2x.png").toExternalForm())));

		editContactBtn.setOnAction(event -> mainController
				.editContact(this.contactDetailsTableView.getSelectionModel().getSelectedItem(), this));

		// Add the delete contact-button in the tool bar
		Button deleteContactBtn = new Button();
		deleteContactBtn.setGraphic(
				new ImageView(new Image(getClass().getResource("./icons/remove_contact@2x.png").toExternalForm())));

		deleteContactBtn.setOnAction(event -> mainController.deleteContact(
				this.contactDetailsTableView.getSelectionModel().getSelectedItem(), this.addressBook, this));
	...
	private MenuBar createMenus() {
		...
		// Edit contact
		Image editContactIcon = new Image(getClass().getResourceAsStream("./icons/edit_contact@2x.png"));
		...
		editContactMenu.setOnAction(event -> mainController
				.editContact(this.contactDetailsTableView.getSelectionModel().getSelectedItem(), this));

		menuEdit.getItems().add(editContactMenu);

		// Remove contact
		Image removeContactIcon = new Image(getClass().getResourceAsStream("./icons/remove_contact@2x.png"));
