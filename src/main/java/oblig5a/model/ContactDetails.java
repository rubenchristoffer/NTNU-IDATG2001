...
/**
 * Holds details about a contact, like name, address and phone number. Based on
...
public class ContactDetails implements Comparable<ContactDetails>, Serializable {
	...
	/**
	 * Sets the name of the contact. If the name is <code>null</code>, or is empty
	 * (length is 0), a {@link java.lang.IllegalArgumentException} will be thrown.
	 *
	...
	/**
	 * Sets the phone number of the contact. If the phone number is
	 * <code>null</code>, or is empty (length is 0), a
	...
	/**
	 * Sets the address of the contact. If the address is <code>null</code>, or is
	 * empty (length is 0), a {@link java.lang.IllegalArgumentException} will be
	 * thrown.
	 *
	...
	public boolean equals(Object other) {
		if (other instanceof ContactDetails) {
			...
			return name.equals(otherDetails.getName()) && phone.equals(otherDetails.getPhone())
	...
	/**
	 * Compare these details against another set, for the purpose of sorting. The
	 * fields are sorted by name, phone, and address.
	 *
	...
	/**
	 * Compute a hashcode using the rules to be found in "Effective Java", by Joshua
	 * Bloch.
	 *
	 ...
	 * be used for debugging purposes. NEVER to be used as part of the interaction
	 * with the user!!
	 *
