...
/**
 * Represents an Address book containing contacts with contact details. Based on
 * the example in the book "Objects first with Java" by David J. Barnes and
 * Michael Kölling.
 *
 * <p>
 * Each contact is stored in a TreeMap using the phone number as the key.
 *
 * @author David J. Barnes and Michael Kölling and Arne Styve
 * @version 2020.03.16
 */
public class AddressBookPlain implements Serializable, AddressBook {
	...
	// TreeMap is a bit less efficient than a HashMap in terms of searching, du to
	// the
	...
	/**
	 * Remove the contact with the given phonenumber from the address book. The
	 * phone number should be one that is currently in use.
	 *
