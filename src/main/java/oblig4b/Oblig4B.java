...
public class Oblig4B extends Application {
	...
	/**
	 * Constructs the object required for
	 * launching Oblig4B.
	 */
	public Oblig4B() {
	...
	/**
	 * This method looks for the MainController
	 * based on a given Node.
	 * @param node is a JavaFX node that either itself
	 * or has a parent that contains the MainController
